...
-- For each business that has modifiers, create ModifierGroups from the distinct types
INSERT INTO "ModifierGroup" ("id", "businessId", "name", "displayOrder", "selectionMode", "updatedAt")
SELECT
    gen_random_uuid()::text,
    "businessId",
    CASE "type"
        WHEN 'MILK' THEN 'Milk Options'
        WHEN 'SYRUP' THEN 'Syrups'
        WHEN 'TOPPING' THEN 'Toppings'
    END,
    CASE "type"
        WHEN 'MILK' THEN 1
        WHEN 'SYRUP' THEN 2
...
ALTER TABLE "Modifier" ADD COLUMN "modifierGroupId" TEXT;

-- Populate modifierGroupId from the type→group mapping
UPDATE "Modifier" m
SET "modifierGroupId" = mg."id"
...
-- Now make modifierGroupId NOT NULL
...
ALTER TABLE "Base" ADD COLUMN "priceCents" INTEGER NOT NULL DEFAULT 0;
UPDATE "Base" SET "priceCents" = ROUND("basePrice" * 100)::integer;

-- Modifier: price (Float dollars) → priceCents (Int cents)
ALTER TABLE "Modifier" ADD COLUMN "priceCents" INTEGER NOT NULL DEFAULT 0;
UPDATE "Modifier" SET "priceCents" = ROUND("price" * 100)::integer;

-- Preset: price (Float dollars) → priceCents (Int cents), defaultSize → defaultVariationId
ALTER TABLE "Preset" ADD COLUMN "priceCents" INTEGER NOT NULL DEFAULT 0;
UPDATE "Preset" SET "priceCents" = ROUND("price" * 100)::integer;
ALTER TABLE "Preset" ADD COLUMN "defaultVariationId" TEXT;
...
ALTER TABLE "Order" ADD COLUMN "paymentAmountCents" INTEGER;
UPDATE "Order" SET
    "subtotalCents" = ROUND("subtotal" * 100)::integer,
    "taxCents" = ROUND("tax" * 100)::integer,
    "totalCents" = ROUND("total" * 100)::integer,
    "paymentAmountCents" = CASE WHEN "paymentAmount" IS NOT NULL THEN ROUND("paymentAmount" * 100)::integer ELSE NULL END;
...
ALTER TABLE "OrderItem" ADD COLUMN "totalPriceCents" INTEGER NOT NULL DEFAULT 0;
...
-- Drop old columns from Base
ALTER TABLE "Base" DROP COLUMN "basePrice";
ALTER TABLE "Base" DROP COLUMN "temperatureConstraint";
ALTER TABLE "Base" DROP COLUMN "posVariationId";
...
ALTER TABLE "Modifier" DROP COLUMN "type";
ALTER TABLE "Modifier" DROP COLUMN "price";
...
ALTER TABLE "Preset" DROP COLUMN "defaultSize";
ALTER TABLE "Preset" DROP COLUMN "price";

-- Drop old columns from Order
ALTER TABLE "Order" DROP COLUMN "subtotal";
ALTER TABLE "Order" DROP COLUMN "tax";
ALTER TABLE "Order" DROP COLUMN "total";
ALTER TABLE "Order" DROP COLUMN "paymentAmount";
